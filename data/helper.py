...
def origin2hap(SNV_matrix, origin,
              num_hap):
    """
    SNV_matrix:
...
def compute_cpr(recovered_haplo,
	true_haplo):
	# """
	# recovered_haplo:
...
def read_true_hap(gt_file, pos_file):
    """
    gt_file:
...
def read_sparseSNVMatrix(mat_file):
    """
...
class PermDict:
    ...
    def __init__(self, perm_vals, pos_idx, numel):
...
def gen_perm(perm):  # Generate next possible permutation for given configuration
...
def permute_distance(perm1, perm2
                    ):
    """
...
def compute_ver(recovered_haplo,
                true_haplo):
    """
